...
namespace com.adjust.sdk
{
    public class Adjust : MonoBehaviour
    {
...
#if UNITY_IOS
        private string appToken = "s9jbwf1f1lvk";
        private string appTokenChinese = "s17t1vum114w";
#endif
#if UNITY_ANDROID
        private string appToken = "stvyc0gw1vy8";
        private string appTokenChinese = "stvyc0gw1vy8";
#endif
        ...
        void Awake()
        {
            ...
            AdjustConfig adjustConfig = new AdjustConfig( EnterScene.IsChinese.Value ? appTokenChinese : this.appToken, this.environment, (this.logLevel == AdjustLogLevel.Suppress));
