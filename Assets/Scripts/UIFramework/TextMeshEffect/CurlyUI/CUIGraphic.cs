...
public class CUIGraphic : BaseMeshEffect
{
    ...
    [Tooltip("设置为true可使曲线/变形生效。设置false以快速查看原始UI.")]
    [SerializeField]
    ...
    [Tooltip("设置为true可根据UI布局的动态更改动态更改曲线")]
    [SerializeField]
    ...
    [Tooltip("除非你确定你在做什么，否则不要碰这个。曲线是自动生成的.")]
    [SerializeField]
