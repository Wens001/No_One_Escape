...
namespace TextureMaker
{
    public class TextureMakerEditor : EditorWindow
    {
        ...
        [MenuItem("MyTools/Texture Maker _F1")]
        ...
        void OnDisable()
        {
            ...
            EditorPrefs.SetString("纹理生成器", data);
        ...
        void OnGUI()
        {
            ...
            Undo.RecordObject(this, "纹理生成器设置");
        ...
        {            
            ...
            if(GUILayout.Button(new GUIContent("重置", "重置当前所有设置."), GUILayout.Height(40)))
            {
                textureModule.Reset();
            ...
            if(GUILayout.Button("保存 " + previewTypeNames[(int)previewType], GUILayout.Height(40)))
            {
                generatedTextureOutput = textureModule.GetTexture(previewType);
        ...
        void DrawPreviewControls()
        {
            ...
            previewSettingsFoldout = EditorGUILayout.BeginFoldoutHeaderGroup(previewSettingsFoldout, "预览设置", foldoutStyle);
            if(previewSettingsFoldout)
            {
                EditorGUI.indentLevel++;
                
                previewType = (PreviewType)EditorGUILayout.EnumPopup("预览类型", previewType);
                ...
                previewMode = (PreviewMode)EditorGUILayout.Popup("实时预览", (int)previewMode, previewModeStrings);
        ...
        {
            EditorGUILayout.LabelField("预览", EditorStyles.centeredGreyMiniLabel, options);
